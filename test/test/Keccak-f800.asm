...
;
; Description: Keccak-f[800] permutation, derived from the Keccak-f[1600] implementation, compact version.
; Version 1 - June 2012.

#define ROT_BIT(a)	 ((a) & 7)
#define ROT_BYTE(a)	 (((a)/8 + !!(((a)%8) > 4)) & 3)
#define PI(a)		 ((a) * 4)
...
Keccak_RoundLoop:
	...
	ldi		TCminus, low(SRAM_ADD_MEM+4*4)
	ldi		TCminus1, high(SRAM_ADD_MEM+4*4)
	ldi		TCplus, low(SRAM_ADD_MEM+1*4)
	ldi		TCplus1, high(SRAM_ADD_MEM+1*4)
	ldi		rY, low(SRAM_STATE)
...
rotate32_nbit_right:
	...
	bld		rTemp3, 7
	dec		RPTemp
	brne	rotate32_nbit_right
	rjmp	KeccakRhoPi_RhoBitRotateDone

rotate32_nbit_leftOrNot:
	tst		RPTemp
