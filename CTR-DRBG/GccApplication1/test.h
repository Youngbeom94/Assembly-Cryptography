...
// AES-CTR (ASM)
void Count_Addition_Asm(u8 *count); //Count 배열에서 값을 1증가시키는 함수
void CRYPTO_ctr128_encrypt_asm(u8* inp, u8* out, u8 len, u8* usrkey, u8* count); //AES CTR Mode of asm
